<template>
  <div id="modal-delete-recording" class="f-modal">
        ...
        <div class="f-modal-content">
          ...
          <div class="modal-popup">
            <div class="modal-popup-content">
              ...
              <h6 v-html="title"></h6>
              <p v-html="content"></p>
              <a href="#" data-dismiss="f-modal" class="btn btn-outline" @click.prevent="$emit('close')">Cancel</a>
              <a href="#" class="btn btn-red" @click.prevent="$emit('delete')">Delete</a>
            </div>
          </div>
        </div>
      </div>
