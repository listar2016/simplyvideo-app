                ...
                <div class="f-modal-content">
                    ...
                    <div class="modal-popup">
                        <div class="modal-popup-content">
                            ...
                            <h6>{{ title }}</h6>
                            <p>
                                To access this feature we need to confirm your idenity. To do this we use your billing details, but don't worry we wont charge you.
                            </p>
                            <a href="#" class="btn btn-primary">Add billing details</a>
                        </div>
                    </div>
                </div>
            </div>
