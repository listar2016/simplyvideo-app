        ...
        <div class="f-modal-table">
            <div class="f-modal-cell">
                <div class="f-modal-content">
                    <div class="f-modal-close" @click="$emit('no')"></div>
                    <div class="modal-popup">
                        <div class="modal-popup-content">
                            ...
                            <a href="#" class="btn btn-outline" @click.prevent="$emit('no')">No</a>
                            <a href="#" class="btn btn-primary" @click.prevent="$emit('yes')">Yes</a>
                        </div>
                    </div>
                </div>
            </div>
