    ...
    <div class="justify-content-center">
        ...
        <div v-else class="row">
            <div class="row col-xl-9 mx-auto">
                <div class="col-12">
                    <h5 class="mb-2 mt-4">Join with a numeric only device</h5>
                </div>
                <div class="col-lg-6">
                    <div class="row">
                            ...
                            <div class="telephone-content">
                                ...
                                <form class="form-horizontal mt-1">
                                    <div class="form-group with-right-icon">
                                        ...
                                        <input type="text" class="form-control border-dash" id="txt-numeric-address" placeholder="Numeric address" v-model="meetingRoom.numeric.address" readonly/>
                                        <a href="#" class="right-icon" @click.prevent="copyAddress('#txt-numeric-address')"><img src="@/assets/img/icons/ic_copy.svg"/></a>
                                    </div>
                                </form>

                                <p>Alternatively, use this address:</p>

                                <form class="form-horizontal">
                                    <div class="form-group with-right-icon">
                                        <label class="sr-only">Alternative address</label>
                                        <input type="text" class="form-control border-dash" id="txt-numeric-alt-address" placeholder="Numeric address" v-model="meetingRoom.numeric.alt_address" readonly/>
                                        <a href="#" class="right-icon" @click.prevent="copyAddress('#txt-numeric-alt-address')"><img src="@/assets/img/icons/ic_copy.svg"/></a>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            copyAddress(selector) { // selector - "#txt-numeric-address" or "#txt-numeric-alt-address"
